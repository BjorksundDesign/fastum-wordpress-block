   ...
   <article <?php echo $wrapper_attrs; ?>>
    ...
    <?php endif; ?>
        ...
        <?php if ($modalType !== 'hero' && $modalType !== 'lime-form'  && count($cards) > 0): ?>
            <div class="cards-grid <?php echo esc_attr(sanitize_html_class($modalType)); ?> <?php echo ($modalType === 'cards' ? esc_attr(sanitize_html_class($cardSize)) : ''); ?>" style="position:relative;z-index:1;">
